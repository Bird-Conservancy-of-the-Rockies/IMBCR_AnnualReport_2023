...
where $p_{[a],tl}$ is a year- and BCR-specific availability component of detection probability, $p_{[p],t}$ is a year-specific perceptibility component of detection probability, and $K_{[s],ijt}⁄K$ is survey effort. Detection components summarize probability vectors,

$$p_{[a],tl}=∑_{r=1}^{R} \mathbf{π_{[a],tl}}$$ {#eq-abundance_p_a}

<center>and</center>

$$p_{[p],tl}=∑_{d=1}^{d_{max}} \mathbf{π_{[p],tl}},$$ {#eq-abundance_p_p}
