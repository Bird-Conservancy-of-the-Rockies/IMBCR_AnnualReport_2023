...
In `r year`, field observers completed 1,513 of 1,557 (97%) planned surveys throughout all or portions of BCRs `r summary$bcr` using the IMBCR design (@tbl-plannedcompleted, @fig-extent). Five surveys were completed above the funded sample effort in two strata. Reasons surveys were not completed are summarized in <a href="#sec-reasons">Table 2</a>.
